...
func TestVisitMarshalJSONUsesFixedMicrosecondTimestamps(t *testing.T) {
	...
	expectedPayload := `{"id":"44444444-4444-4444-8444-444444444444","doctor_id":"11111111-1111-4111-8111-111111111111","patient_id":"22222222-2222-4222-8222-222222222222","clinic_id":"33333333-3333-4333-8333-333333333333","status":"SCHEDULED","visit_start_time":"2026-08-04T18:37:01.004990+03:00","visit_end_time":"2026-08-04T19:37:01.120000+03:00","created_at":"2026-08-04T12:00:00.000000+00:00","updated_at":"2026-08-04T12:00:01.999999+00:00"}`
	if string(payload) != expectedPayload {
		t.Errorf("expected JSON payload %s, got %s", expectedPayload, payload)
	}
