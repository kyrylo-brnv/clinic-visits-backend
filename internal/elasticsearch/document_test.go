	...
	tests := []struct {
		...
		},
		{
			...
			document: PatientDocument{
				...
				IsDeleted: false, CreatedAt: createdAt, UpdatedAt: updatedAt, Visits: []VisitSummary{visit},
			},
		...
		},
		{
			...
			document: VisitDocument{
				...
				Patient: VisitPatientData{ID: "patient-1", FirstName: "Grace", LastName: "Hopper", DateOfBirth: dateOfBirth, Gender: "FEMALE", IsDeleted: false},
